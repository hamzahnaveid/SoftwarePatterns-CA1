...
public class Menu extends JFrame{
	...
	public void customerSelected() {
		boolean customerFound = false, passwordCorrect = false;;
	...
	public Customer retrieveCustomer() {
		...
		while(!customerFound)
	    {
	    Object customerID = JOptionPane.showInputDialog(f, "Enter Customer ID of Customer");
	...
	public void validatePin() {
		int accountPin = ((CustomerCurrentAccount) acc).getAtm().getPin();
		...
		for (int count = 3; count >= 0; count--) {
			...
			String pinStr = JOptionPane.showInputDialog(f, "Enter 4 digit PIN;");
